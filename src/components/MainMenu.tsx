...
export const MainMenu: React.FC<MainMenuProps> = ({
  ...
  const projectTools: MenuItem[] = [
    {
      label: "📁 Update Latest Versions Sent - Updates all shots with their latest delivered version",
    ...
    {
      label: "📁 Delete Media - Delete media (versions or components) with preview and confirmation",
      value: "deleteMedia",
    },
    {
      label: "📁 Propagate Thumbnails - Update shots with thumbnails from their latest versions",
  ...
  const globalTools: MenuItem[] = [
    {
      label: "🌍 Export Schema - Dev Tool: Exports schema information for major entity types",
      value: "exportSchema",
      hasSubMenu: true,
    },
    {
      label: "🌍 Inspect Version - Inspect a specific version's details and relationships",
      value: "inspectVersion",
    },
    {
      label: "🌍 Inspect Shot - Inspect a specific shot's details and relationships",
      value: "inspectShot",
    },
    {
      label: "🌍 Inspect Task - Inspect a specific task's details and relationships",
      value: "inspectTask",
    },
    {
